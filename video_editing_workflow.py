...
class VideoEditingWorkflow:
  ...
  def generate_video_from_content(self):
    ...
    # silent_video_file_clip = VideoFileClip(self.video_file_path + "/outputSilent.mp4")
    ...
    subtitled_video_file_clip = VideoFileClip("output/video_GVgMZMez_test/outputSubtitled.mp4")
